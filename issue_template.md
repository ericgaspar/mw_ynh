...
2. *Determine if you are on the right place:*
   ...
   - *Otherwise, the issue may be due to mumble-web itself. Refer to its documentation or repository for help.*
...
- If upgrading, current package version: *can be found in the admin, or with `yunohost app info mumble-web`*

**To Reproduce**
*Steps to reproduce the behavior.*
- *If you performed a command from the CLI, the command itself is enough. For example:*
    ```sh
    sudo yunohost app install mumble-web
    ```
